  ...
  implements FilterHasBounds
{
  ...
  public boolean accept(Node node)
  {
    ...
    Log.getInstance().log(Level.FINER, "{0}-BoundsFilter, Accepted by, Filter: {1}, BoundsMarker: {2}, Node: {3}", getClass(), getId(), Boolean.valueOf(filterAccept), Boolean.valueOf(boundsAccept), node);
