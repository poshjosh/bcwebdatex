...
import com.bc.webdatex.filters.FilterFactory.FilterType;
...
public class FilterFactory
{
  ...
  private static NodeFilter newTagNameFilter(JsonConfig config, Object[] propertyKey)
  {
    ...
    Log.getInstance().log(Level.FINER, "PropertyKey: {0}, Node to create filter for: {1}", FilterFactory.class, ID, nodeName);
    

    if (nodeName == null) { 
        return null;
    }
    final Level level = getLogLevel(propertyKey[0].toString());
    ...
    return new TagNameFilter(nodeName)
    {
      ...
      public boolean accept(Node node)
      {
        ...
        Log.getInstance().log(level, "{0}-TagnameFilter, Accept: {1}, Node: {2}", getClass(), ID, Boolean.valueOf(accept), node);
  ...
  private static NodeFilter newTagNameOnlyFilter(JsonConfig config, Object[] propertyKey)
  {
    ...
    return new TagNameOnlyFilter(nodeName)
    {
      public boolean accept(Node node) {
        boolean accept = super.accept(node);
        Log.getInstance().log(level, "TagNameOnlyFilter, Accept: {0}, Node: {1}", getClass(), Boolean.valueOf(accept), node);
  ...
  public static NodeFilter newHasAttributesRegexFilter(Object[] propertyKey, final Map<String, String> attributes)
  {
    ...
    Log.getInstance().log(Level.FINER, "Attributes to create filter for: {0}={1}", FilterFactory.class, ID, attributes);
    ...
    for (String key : attributes.keySet()) {
      ...
      Log.getInstance().log(Level.FINEST, "@newAttributesRegexInstance. Key: {0}, Value: {1}", FilterFactory.class, key, value);
    ...
    AndFilter andFilter = new AndFilter(predicates)
    {
      public boolean accept(Node node)
      {
        ...
        Log.getInstance().log(level, "{0}-HasAttributesRegexFilter, Accept: {1}, Node: {2}", getClass(), ID, Boolean.valueOf(accept), node);
  ...
  public static NodeFilter newHasAttributesFilter(Object[] propertyKey, final Map<String, String> attributes)
  {
    ...
    for (String key : attributes.keySet()) {
      Object value = attributes.get(key);
      Log.getInstance().log(Level.FINEST, "@newAttributesInstance. Key: {0}, Value: {1}", FilterFactory.class, key, value);
    ...
    return new AndFilter(predicates)
    {
      public boolean accept(Node node)
      {
        ...
        Log.getInstance().log(level, "{0}-HasAttributesFilter, Accept: {1}, Node: {2}", getClass(), ID, Boolean.valueOf(accept), node);
  ...
  private static NodeFilter newHasIdAttributeFilter(JsonConfig config, Object[] propertyKey)
  {
    ...
    Log.getInstance().log(Level.FINER, "{0}-HasIdAttribute. id value: {1}", FilterFactory.class, ID, idValue);
    ...
    return new HasAttributeFilter("id", idValue)
    {
      public boolean accept(Node node) {
        boolean accept = super.accept(node);
        Log.getInstance().log(level, "HasIdAttributeFilter. Accept: {0}, Node: {1}", getClass(), Boolean.valueOf(accept), node);
  ...
  private static NodeFilter newUnwantedTextFilter(JsonConfig props, Object[] propertyKey, FilterType type)
  {
    ...
    Log.getInstance().log(Level.FINER, "{0}={1}", FilterFactory.class, ID, toReject == null ? null : Arrays.asList(toReject));
    ...
    return new NodeFilter()
    {
      ...
      public boolean accept(Node node)
      {
        ...
        Log.getInstance().log(level, "UnwantedTextFilter, Accept: {0}, Node: {1}", getClass(), Boolean.valueOf(accept), node);
  ...
  private static NodeFilter newRejectNodeFilter(JsonConfig props, Object[] propertyKey)
  {
    ...
    final Level level = getLogLevel(pathToValue[0].toString());
    ...
    for (int i = 0; i < maxFiltersPerKey; i++)
    {
      ...
      if (props.getString(pathToValue) != null)
      {
        ...
        Log.getInstance().log(Level.FINER, "Id: {0}, Filter: {1}", FilterFactory.class, ID, filter);
        ...
        if (filter != null)
        {
          ...
          NotFilter notFilter = new NotFilter(filter)
          {
            public boolean accept(Node node) {
              ...
              Log.getInstance().log(level, "{0}-RejectNodeFilter, Accept: {1}, Node: {2}", getClass(), ID, Boolean.valueOf(b), node);
  ...
  public static NodeFilter newNodesFilter(final String[] nodeIds, Object[] propertyKey, final FilterType filterType)
  {
    ...
    Log.getInstance().log(Level.FINER, "{0}={1}", FilterFactory.class, ID, nodeIds == null ? null : Arrays.toString(nodeIds));
    ...
    return new NodeFilter()
    {
      ...
      public boolean accept(Node node)
      {
        ...
        Log.getInstance().log(level, "{0}-{1}Filter, accept: {2}, Node: {3}", getClass(), ID, filterType, Boolean.valueOf(accept), node);
  ...
  public static NodeFilter newOffsetFilter(final NodeVisitingFilter filter, JsonConfig props, final String propertyKey)
  {
    ...
    final Level level = getLogLevel(propertyKey);
    ...
    NodeFilter offsetFilter = new NodeFilter()
    {
      public boolean accept(Node node) {
        ...
        Log.getInstance().log(level, "{0}-OffsetFilter, Accept: {1}, Index: {2}, Node: {3}", getClass(), propertyKey, Boolean.valueOf(accept), Integer.valueOf(filter.getVisitedStartTags()), node);
  ...
  public static NodeFilter newLengthFilter(final NodeVisitingFilter filter, JsonConfig props, final String propertyKey)
  {
    ...
    NodeFilter lengthFilter = new NodeFilter()
    {
      public boolean accept(Node node) {
        ...
        Log.getInstance().log(level, "LengthFilter, Accept: {0}, Node: {1}", getClass(), Boolean.valueOf(accept), node);
  ...
  private static Level getLogLevel(String propertyKey) {
    return isTrackLog(propertyKey) ? Level.FINE : Level.FINER;
  }
  
  private static boolean isTrackLog(String propertyKey) {
    return false;
  }
  ...
  private static int indexOf(String[] arr, String elem, boolean equals) {
    ...
    synchronized (arr) {
      for (int i = 0; i < arr.length; i++) {
        ...
        Log.getInstance().log(Level.FINEST, "Found {0}, {1} in: {2}", FilterFactory.class, Boolean.valueOf(found), arr[i], elem);
