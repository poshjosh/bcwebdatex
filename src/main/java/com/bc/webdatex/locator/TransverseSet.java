...
Log.getInstance().log(Level.FINER, "Input: {0}, output: {1}",
...
Log.getInstance().log(Level.FINER, "Horizontal transverse: {0}\nLast element: {1}, to compare: {2}",
...
Log.getInstance().log(Level.FINER, "To remove: {0}, Node {1} does not match {2}",
