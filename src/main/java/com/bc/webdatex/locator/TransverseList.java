...
Log.getInstance().log(Level.FINER, "Vertical path: {0}", 
...
Log.getInstance().log(Level.FINER, "Index: {0}, horizontal path: {1}", 
...
Log.getInstance().log(Level.FINER, "Vertical. Input: {0}\nOutput:{1}", 
...
Log.getInstance().log(Level.FINER, "Horizontal. Input: {0}\nOutput:{1}", 
