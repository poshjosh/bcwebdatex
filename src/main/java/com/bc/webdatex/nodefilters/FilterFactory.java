...
Log.getInstance().log(Level.FINER, "PropertyKey: {0}, Node to create filter for: {1}", 
...
Log.getInstance().log(Level.FINER, "{0}-TagnameFilter, Accept: {1}, Node: {2}", 
...
FilterFactory.class, ID, nodeName);        
        ...
        return new TagNameOnlyFilter(nodeName){
            ...
            public boolean accept(Node node) {
                boolean accept = super.accept(node);
Log.getInstance().log(Level.FINER, "TagNameOnlyFilter, Accept: {0}, Node: {1}", 
...
Log.getInstance().log(Level.FINER, "Attributes to create filter for: {0}={1}", 
...
Log.getInstance().log(Level.FINEST, "@newAttributesRegexInstance. Key: {0}, Value: {1}", 
...
Log.getInstance().log(Level.FINER, "{0}-HasAttributesRegexFilter, Accept: {1}, Node: {2}", 
this.getClass(), ID, accept, node);                
                return accept;
            }
            @Override
...
Log.getInstance().log(Level.FINEST, "@newAttributesInstance. Key: {0}, Value: {1}", 
FilterFactory.class, key, value);
...
Log.getInstance().log(Level.FINER, "{0}-HasAttributesFilter, Accept: {1}, Node: {2}", 
this.getClass(), ID, accept, node);                
...
Log.getInstance().log(Level.FINER, "{0}-HasIdAttribute. id value: {1}", 
FilterFactory.class, filterID, value);        
        ...
        return new HasAttributeFilter(name, value){
            ...
            public boolean accept(Node node) {
                boolean accept = super.accept(node);
Log.getInstance().log(Level.FINER, "HasIdAttributeFilter. Accept: {0}, Node: {1}", 
this.getClass(), accept, node);                
                return accept;
            }
            @Override
...
Log.getInstance().log(Level.FINER, "{0}={1}", 
FilterFactory.class, ID,toReject==null?null:Arrays.asList(toReject));        
        ...
        TextFilter filter = new TextFilterImpl() {
            ...
            public boolean accept(Node node) {
                boolean accept = super.accept(node);
Log.getInstance().log(Level.FINER, "UnwantedTextFilter, Accept: {0}, Node: {1}", 
this.getClass(), accept, node);                
                return accept;
            }
            @Override
...
Log.getInstance().log(Level.FINER, "{0}-{1}Filter, accept: {2}, Node: {3}", 
