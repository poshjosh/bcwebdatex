...
XLogger.getInstance().log(level, "Locator accept: {0}, found target: {1}, within bounds: {2}, within target: {3}", 
...
if(!started) {            
    XLogger.getInstance().log(Level.FINER, "{0}-{1} STARTED ", this.getClass(), id, this.getClass().getSimpleName());
}            
            started = true;
...
XLogger.getInstance().log(Level.FINER, "{0}-{1} DONE ", this.getClass(), id, this.getClass().getSimpleName());
            }
...
XLogger.getInstance().log(Level.FINER, "  Expected end tags: {0}\nTransverse end tags: {1}", 
...
XLogger.getInstance().log(Level.FINER, "Is within: {0}, is started: {1}, is done: {2}", 
...
XLogger.getInstance().log(Level.FINEST, "Transverse end tags: {0}", this.getClass(), this.toSimpleString(transverseEndTags));
        }
    }
...
XLogger.getInstance().log(Level.FINEST, "Expected end tags: {0}", this.getClass(), this.toSimpleString(expectedEndTags));
        }
    }
