...
XLogger.getInstance().log(Level.FINEST, "Pattern: {0}, replacement: {1}", this.getClass(), pattern.pattern(), replacement);
        
        String output = pattern.matcher(input).replaceAll(Matcher.quoteReplacement(replacement));        

XLogger.getInstance().log(Level.FINEST, "Regex: {0}, quote: {1}\n Input: {2}\nOutput: {3}", 
...
XLogger.getInstance().log(Level.FINE, "Parents: {0}, Siblings: {1}", 
